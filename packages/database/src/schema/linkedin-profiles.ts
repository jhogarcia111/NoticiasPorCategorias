import { pgTable, text, timestamp, serial, boolean, uniqueIndex } from "drizzle-orm/pg-core"
...
export const linkedinProfiles = pgTable(
  ...
  (t) => [
    uniqueIndex("linkedin_profiles_user_li_unique").on(t.userId, t.linkedinId),
  ],
)
