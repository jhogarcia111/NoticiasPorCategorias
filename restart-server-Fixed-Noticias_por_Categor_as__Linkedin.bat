...
echo ========================================
echo 🔄 Reiniciando Servidores de Noticias por Categorías- Linkedin
echo ========================================
echo.
...
echo title "Noticias por Categorías- Linkedin - Backend"
...
echo echo ========================================
echo echo.
echo start /b cmd /c "for /l %%%%i in (1,0,2) do @title "Noticias por Categorías- Linkedin - Backend" ^& timeout /t 2 /nobreak ^>nul"
...
echo title "Noticias por Categorías- Linkedin - Frontend"
echo set TZ=America/Bogota
...
echo echo ========================================
echo echo.
echo start /b cmd /c "for /l %%%%i in (1,0,2) do @title "Noticias por Categorías- Linkedin - Frontend" ^& timeout /t 2 /nobreak ^>nul"
echo call npm.cmd run dev
echo pause
) > "%FRONTEND_BAT_WT%"

start "" wt.exe new-tab --title "Noticias por Categorías- Linkedin - Backend" cmd /k "%BACKEND_BAT_WT%" ; new-tab --title "Noticias por Categorías- Linkedin - Frontend" cmd /k "%FRONTEND_BAT_WT%"
echo.
