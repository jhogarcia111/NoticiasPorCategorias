-- Script definitivo para arreglar todas las tablas de LinkedIn
-- Ejecutar en Supabase SQL Editor

-- 1. Verificar qué tablas existen y sus tipos
SELECT 
  table_name,
  column_name,
  data_type,
...
-- 2. Eliminar foreign keys problemáticas si existen
...
-- 3. Eliminar tablas problemáticas completamente (CUIDADO: esto borrará datos)
DROP TABLE IF EXISTS scheduling_configs CASCADE;
DROP TABLE IF EXISTS scheduled_posts CASCADE;
DROP TABLE IF EXISTS linkedin_profiles CASCADE;

-- 4. Crear tabla linkedin_profiles desde cero
...
-- 6. Crear tabla scheduling_configs
...
-- 15. Verificar tipos de columnas
SELECT 
  table_name,
  column_name,
  data_type,
