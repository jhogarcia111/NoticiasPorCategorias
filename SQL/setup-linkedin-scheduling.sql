-- Script para configurar LinkedIn y Sistema de Programación
-- Ejecutar en Supabase SQL Editor

-- 1. Crear tabla de perfiles de LinkedIn
...
-- 2. Crear tabla para programar publicaciones
...
-- 3. Crear tabla para configuraciones de programación
...
-- 6. Políticas RLS para linkedin_profiles
...
-- 7. Políticas RLS para scheduled_posts
...
-- 8. Políticas RLS para scheduling_configs
