...
export const NewsList = ({ news, onNewsSelect, selectedNews = [] }) => {
  ...
  const isSelected = (newsId) => selectedNews.includes(newsId)
  const isExpanded = (newsId) => expandedNews[newsId]
          ...
          <CardHeader className="pb-3">
            <div className="flex items-start justify-between">
              ...
              <div className="ml-4 flex flex-col items-end space-y-2">
                <Badge 
                  variant={article.is_processed ? 'success' : 'warning'}
                  className="text-xs"
                >
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between pt-2 border-t">
                    <div className="text-xs text-gray-500">
                      ID: {article.id} | Creado: {new Date(article.created_at).toLocaleString('es-ES')}
                    </div>
                    <Button
